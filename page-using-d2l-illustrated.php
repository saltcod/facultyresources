...
<div class="row d2l-tools first group"> 
	...
	<h3 class="center">Information for new and experienced users.</h3>
  	...
  	<a href="../guides/getting-started"><button class="blue">See how</button></a>
</div>		 
...
<div class="row d2l-tools course-content group">
	...
	<div class="right-side">		
		<h2 class="section-title">Course Content</h2>	  
			...
			<a href="../guides/the-content-tool"><button class="blue">Explore</button></a>
	</div>	
</div>		 
	...
	<div class="triangle"></div>
 	...
 	<div class="group">
		...
		<ul>
			...
			<li class="last"><a href="../guides/the-classlist"><button class="blue">See how</button></a></li>
		</ul>
...
<div class="row d2l-tools communicate-collaborate group">
 ...
 <br> <span> Office Hours. Online Chats. Anytime, anywhere. </span>
...
<div class="row d2l-tools dropbox group">
	...
	<div class="left-side">		
		...
		<a class="button" href="../guides/the-dropbox"><button class="blue">See how</button></a>
	</div>
...
<div class="row d2l-tools grades-tool group">
	<div class="triangle"></div>
		...
		<a class="button" href="../guides/the-grades-tool"><button class="blue">Explore</button></a>
